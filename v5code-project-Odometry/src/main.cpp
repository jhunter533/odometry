 ...
 */
 ...
 Brain.Screen.print("90 %.5f", cos(90));
 Brain.Screen.newLine();
 Brain.Screen.print("pi/2 %.5f", cos(pi/2));
 Brain.Screen.newLine();
  Brain.Screen.print("pi/2 %.5f", cos(1.57079));
 Brain.Screen.newLine();
 wait(5,sec);
 Brain.Screen.clearScreen();
 Brain.Screen.setCursor(1,1);
 */
 //Controller1.Screen.print("%.5f", );
     Brain.Screen.print("angle %.5f", absoluteAngle);
 Brain.Screen.newLine();
